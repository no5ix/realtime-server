...
@REM     --initial-advertise-peer-urls http://0.0.0.0:2380 ^
@REM     --listen-peer-urls http://0.0.0.0:2380 ^
@REM     --listen-client-urls http://0.0.0.0:2379 ^
@REM     --advertise-client-urls http://0.0.0.0:2379 ^
...
start /b etcd\etcd.exe --name infra0 ^
    ...
    --initial-cluster infra0=http://0.0.0.0:2380,infra1=http://0.0.0.0:2382,infra2=http://0.0.0.0:2384 ^
    --initial-cluster-state new

start /b etcd\etcd.exe --name infra1 ^
    --initial-advertise-peer-urls http://0.0.0.0:2382 ^
    --listen-peer-urls http://0.0.0.0:2382 ^
    --listen-client-urls http://0.0.0.0:2381,http://127.0.0.1:2381 ^
...
start /b etcd\etcd.exe --name infra2 ^
    --initial-advertise-peer-urls http://0.0.0.0:2384 ^
    --listen-peer-urls http://0.0.0.0:2384 ^
    --listen-client-urls http://0.0.0.0:2383,http://127.0.0.1:2383 ^
